        ...
        <template slot="header">
          <div class="row">
            ...
            <div class="col-sm-6 d-flex d-sm-block">
              ...
              >
                <label
                  v-for="(option, index) in mainChartCategories"
                  :key="option.name"
...
export default {
  ...
  computed: {
    ...
    user_id () {
      console.log("computed: " + this.$store.state.user.currentUser.id);
    ...
    mainChartCategories () {
      return [
        { name: 'Daily', shortname: 'Daily' },
        { name: 'Weekly', shortname: 'Weekly'},
        { name: 'Monthly', shortname: 'Monthly' },
        { name: 'Annual', shortname: 'Annual' }
      ];
    }
  },
  methods: {
